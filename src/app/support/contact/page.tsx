    ...
    <div className="page-container bg-brutal-gray">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white border-[3px] border-black p-6 md:p-8" style={{ boxShadow: '4px 4px 0 0 #000000' }}>
          ...
          {/* FAQs */}
          <div className="mt-8 bg-white border-[3px] border-black p-6 md:p-8" style={{ boxShadow: '4px 4px 0 0 #000000' }}>
            <div className="flex items-center mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`mailto:${supportEmail}`} className="text-black hover:underline font-medium">{supportEmail}</a>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href={`tel:${supportPhone}`} className="text-black hover:underline font-medium">{supportPhone}</a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex space-x-3 mt-2">
                    <a href={facebookUrl} target="_blank" rel="noreferrer" className="bg-brutal-gray hover:bg-gray-200 p-2 border-[2px] border-black transition-colors">
                    ...
                    <a href={lineUrl} target="_blank" rel="noreferrer" className="bg-brutal-gray hover:bg-gray-200 p-2 border-[2px] border-black transition-colors">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                      </svg>
                    </a>
                    <a href={discordUrl} target="_blank" rel="noreferrer" className="bg-brutal-gray hover:bg-gray-200 p-2 border-[2px] border-black transition-colors">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="#" className="bg-brutal-gray hover:bg-gray-200 p-2 border-[2px] border-black transition-colors">
                      <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
