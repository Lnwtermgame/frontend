...
/** ธงภูมิภาคสำหรับ badge บนการ์ดสินค้า — GLOBAL ใช้ไอคอนลูกโลก ภูมิภาคอื่นใช้ธงประเทศ (ชุด nucleo-flags ครบ ~250 ประเทศ) */
export function RegionFlag({ region, className }: RegionFlagProps) {
  if (region === "GLOBAL") {
    return <RegionFlagIcon code="global" className={className} />;
  }
