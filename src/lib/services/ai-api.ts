...
4. **แยกหัวข้อชัดเจน** อย่าเขียนรวมกันเป็น paragraph ยาวๆ
5. **วิธีเติมต้องตรงกับ Required Information จริง** ห้ามสร้างขั้นตอนที่ไม่มีอยู่จริง

โครงสร้างที่ต้องการ (แยกหัวข้อชัดเจน):

**1. บทนำสินค้า**
- อธิบายว่าสินค้านี้คืออะไร ใช้ทำอะไรได้บ้าง
- ระบุเซิร์ฟเวอร์/ภูมิภาค (ถ้ามี)

**2. รายละเอียดเกม**
- ข้อมูลทั่วไปของเกม
- ประเภทไอเทมที่สามารถซื้อได้ (เพชร, สกิน, ฮีโร่, ฯลฯ)
- ประโยชน์ของไอเทม

**3. Required Information (ข้อมูลที่ต้องใช้)**
- ระบุชัดเจนว่าต้องใช้อะไรบ้าง (เช่น User ID, Zone ID)
- วิธีหาข้อมูลเหล่านี้ในเกม

**4. วิธีการสั่งซื้อ**
- ขั้นตอนที่ 1: เลือกจำนวน/แพ็กเกจ
- ขั้นตอนที่ 2: กรอกข้อมูลที่จำเป็น
- ขั้นตอนที่ 3: ชำระเงิน
- ขั้นตอนที่ 4: รอรับไอเทม
...
- ตรวจสอบข้อมูลให้ถูกต้องก่อนสั่งซื้อ
- ข้อมูลผิดพลาดไม่สามารถคืนเงินได้

**7. คำกระตุ้นการตัดสินใจ**

ตัวอย่างที่ถูกต้อง (แยกหัวข้อชัดเจน ไม่รวม paragraph):

เติมเพชร Mobile Legends ประเทศมาเลเซีย ด้วยระบบอัตโนมัติที่รวดเร็วและปลอดภัย เหมาะสำหรับการซื้อฮีโร่ใหม่ สกินสวยๆ หรือสมัคร Starlight Member บนเซิร์ฟเวอร์มาเลเซีย

รายละเอียดเกม:
Mobile Legends: Bang Bang เป็นเกม MOBA บนมือถือที่ได้รับความนิยมสูงสุดในเอเชียตะวันออกเฉียงใต้ เพชร (Diamonds) เป็นเหรียญพรีเมียมที่ใช้ซื้อฮีโร่ สกิน ไอเทมตกแต่ง และสมัครสมาชิก Starlight ซึ่งจะช่วยยกระดับประสบการณ์การเล่นเกมของคุณให้สนุกและโดดเด่นกว่าใคร
...
จุดเด่นของบริการ:
- เติมตรงผ่านระบบ API อย่างเป็นทางการ
- รวดเร็ว ไม่ต้องรอนาน
- ปลอดภัย 100% ไม่มีบัญชีไกล
...
ห้ามทำ:
- ใช้ไอคอนรูปแบบ [IconName]
- ใช้อิโมจิใดๆ
- เขียนรวม paragraph ยาวๆ ไม่มีหัวข้อ
- สร้างขั้นตอนวิธีใช้ที่ไม่มีอยู่จริง
- ใช้คำพูดซ้ำซาก เช่น "เติมเงินง่ายนิดเดียว" ซ้ำหลายครั้ง

เขียนคำอธิบายตอนนี้ (แยกหัวข้อชัดเจน ไม่มีไอคอน):`;
  }
