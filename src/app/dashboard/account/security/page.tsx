  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col gap-6">
              ...
              {showChangePassword ? (
                ...
                <div>
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-black mb-1 thai-font">อัปเดตรหัสผ่าน</h3>
              ...
              {securitySettings.twoFactorEnabled ? (
                ...
                <div className="space-y-6">
                  ...
                  {!twoFactorSetupData.secret && (
                    <div>
                      <h3 className="font-bold text-black mb-3 thai-font">เลือกวิธีการยืนยันตัวตน</h3>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        <button
                          onClick={() => setTwoFactorMethod('2fa-app')}
                          className={`p-3 border-[2px] flex flex-col items-center ${twoFactorMethod === '2fa-app'
                            ? 'border-black bg-brutal-blue'
                            : 'border-gray-300 hover:border-black'
                            }`}
                        >
                          <Smartphone size={24} className={twoFactorMethod === '2fa-app' ? 'text-black' : 'text-gray-600'} />
                          <span className={`text-sm mt-2 thai-font ${twoFactorMethod === '2fa-app' ? 'text-black font-bold' : 'text-gray-600'}`}>
                            แอพ Authenticator
                          </span>
                        </button>
                        ...
                        <button
                          ...
                          className={`p-3 border-[2px] flex flex-col items-center ${twoFactorMethod === 'sms'
                            ? 'border-black bg-brutal-blue'
                            : 'border-gray-300 hover:border-black'
                            }`}
                        >
                          <Phone size={24} className={twoFactorMethod === 'sms' ? 'text-black' : 'text-gray-600'} />
                          <span className={`text-sm mt-2 thai-font ${twoFactorMethod === 'sms' ? 'text-black font-bold' : 'text-gray-600'}`}>
                            SMS
                          </span>
                        </button>
                        ...
                        <button
                          ...
                          className={`p-3 border-[2px] flex flex-col items-center ${twoFactorMethod === 'email'
                            ? 'border-black bg-brutal-blue'
                            : 'border-gray-300 hover:border-black'
                            }`}
                        >
                          <Mail size={24} className={twoFactorMethod === 'email' ? 'text-black' : 'text-gray-600'} />
                          <span className={`text-sm mt-2 thai-font ${twoFactorMethod === 'email' ? 'text-black font-bold' : 'text-gray-600'}`}>
                            อีเมล
                          </span>
                        </button>
                      </div>
                  ...
                  {twoFactorSetupData.secret && twoFactorMethod === '2fa-app' && (
                    <div>
                      <h3 className="font-bold text-black mb-3 thai-font">ตั้งค่าแอพ Authenticator</h3>
                      <ol className="space-y-4 mb-6">
                        <li className="flex gap-3">
                          <span className="flex-shrink-0 w-6 h-6 bg-brutal-blue border-[2px] border-black text-black flex items-center justify-center text-sm font-bold">1</span>
                          <div>
                        ...
                        <li className="flex gap-3">
                          <span className="flex-shrink-0 w-6 h-6 bg-brutal-blue border-[2px] border-black text-black flex items-center justify-center text-sm font-bold">2</span>
                          <div>
                        ...
                        <li className="flex gap-3">
                          <span className="flex-shrink-0 w-6 h-6 bg-brutal-blue border-[2px] border-black text-black flex items-center justify-center text-sm font-bold">3</span>
                          <div>
                            <p className="text-gray-600 thai-font">
                        ...
                        <li className="flex gap-3">
                          <span className="flex-shrink-0 w-6 h-6 bg-brutal-blue border-[2px] border-black text-black flex items-center justify-center text-sm font-bold">4</span>
                          <div>
                  ...
                  {twoFactorSetupData.secret && twoFactorMethod === 'sms' && (
                    <div>
                      <h3 className="font-bold text-black mb-3 thai-font">ตั้งค่าการยืนยันผ่าน SMS</h3>
                  ...
                  {twoFactorSetupData.secret && twoFactorMethod === 'email' && (
                    <div>
                      <h3 className="font-bold text-black mb-3 thai-font">ตั้งค่าการยืนยันผ่านอีเมล</h3>
                      <div className="space-y-4 mb-6">
                        <div>
                          <label className="block text-sm text-gray-600 mb-2 thai-font">
                            อีเมลของคุณ
            ...
            {showBackupCodes && (
              <div className="p-4 border-t-[3px] border-black bg-brutal-yellow/20">
                <div className="flex justify-between items-center mb-3">
                  <h3 className="font-bold text-black thai-font">รหัสสำรอง</h3>
                  <button
        ...
        {securitySettings.suspiciousActivities.length > 0 && (
          <div className="bg-white border-[3px] border-black" style={{ boxShadow: '4px 4px 0 0 #000000' }}>
            <div className="p-4 bg-red-100 border-b-[3px] border-black">
              <h2 className="text-lg font-bold text-black thai-font">กิจกรรมที่น่าสงสัย</h2>
            </div>
        ...
        <div className="bg-white border-[3px] border-black" style={{ boxShadow: '4px 4px 0 0 #000000' }}>
          <div className="p-4 bg-brutal-yellow border-b-[3px] border-black">
            <h2 className="text-lg font-bold text-black thai-font">การตั้งค่าเพิ่มเติม</h2>
          </div>
