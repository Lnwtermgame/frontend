...
export const gamesData: Record<string, GameDetails> = {
  ...
  "free-fire": {
    ...
    ratingCount: 9876,
    description:
      "Garena Free Fire is a battle royale game where 50 players parachute onto a remote island and fight to be the last person standing.",
    longDescription:
      "Garena Free Fire is an ultimate survival shooter game available on mobile. Each 10-minute game places you on a remote island where you are pit against 49 other players, all seeking survival. Players freely choose their starting point with their parachute, and aim to stay in the safe zone for as long as possible.",
    features: [
  ...
  "mobile-legends": {
    ...
    ratingCount: 8542,
    description:
      "Mobile Legends: Bang Bang is a mobile MOBA game where two opposing teams fight to reach and destroy the enemy base.",
    longDescription:
      "Mobile Legends: Bang Bang is a multiplayer online battle arena (MOBA) game designed for mobile phones. The game pits two teams of five against each other in real-time battles, with the ultimate goal of destroying the enemy base while protecting your own.",
    features: [
  ...
  "apex-legends": {
    ...
    description:
      "Conquer with character in Apex Legends, a free-to-play Hero Shooter.",
    topUpOptions: [
      {
        id: "apex-1000-coins",
        title: "1000 Apex Coins",
        price: 9.99,
        originalPrice: 9.99,
        isPopular: true,
        bonus: 0,
  ...
  "call-of-duty-mobile": {
    ...
    description:
      "Call of Duty: Mobile delivers the definitive first-person action experience on mobile.",
    topUpOptions: [
      {
        id: "codm-80-cp",
        title: "80 CP",
  ...
  "arena-of-valor": {
    ...
    description:
      "Experience AOV (Arena of Valor), an epic new 5v5 multiplayer online battle arena (MOBA).",
    topUpOptions: [
      {
        id: "aov-vouchers",
        title: "Vouchers",
