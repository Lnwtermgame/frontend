...
export function getCountryFlagCode(
  ...
  if (directCodes.includes(key)) return key.toUpperCase();
  ...
  if (key.includes("global") || key.includes("world")) return "UN";
  if (key.includes("united states") || key.includes("usa")) return "US";
  return null;
}
