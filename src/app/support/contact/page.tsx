    ...
    <div className="page-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-mali-card border border-mali-blue/20 rounded-xl p-6 md:p-8">
            ...
            {formStatus === 'success' ? (
              ...
              >
                ...
                <p className="text-mali-text-secondary mb-6">Thank you for contacting us. Our support team will get back to you within 24 hours.</p>
                <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-mali-text-secondary mb-2">Full Name</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                      ...
                      required
                      className="w-full py-3 px-4 bg-mali-blue/10 border border-mali-blue/30 rounded-lg text-white focus:outline-none focus:border-mali-blue-accent focus:ring-1 focus:ring-mali-blue-accent"
                      placeholder="Enter your name"
                    />
                  </div>

                  <div>
                    <label htmlFor="email" className="block text-mali-text-secondary mb-2">Email Address</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="category" className="block text-mali-text-secondary mb-2">Issue Category</label>
                    <select
                      id="category"
                      name="category"
                  ...
                  <div>
                    <label htmlFor="orderId" className="block text-mali-text-secondary mb-2">Order ID (if applicable)</label>
                    <input
                      type="text"
                      id="orderId"
                      name="orderId"
                ...
                <div>
                  <label htmlFor="message" className="block text-mali-text-secondary mb-2">Message</label>
                  <textarea
                    id="message"
                    name="message"
                ...
                <button
                  ...
                  className={`bg-mali-blue hover:bg-mali-blue/90 text-white px-6 py-3 rounded-lg font-medium flex items-center justify-center ${formStatus === 'submitting' ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
          ...
          {/* FAQs */}
          <div className="mt-8 bg-mali-card border border-mali-blue/20 rounded-xl p-6 md:p-8">
            <div className="flex items-center mb-6">
              <HelpCircle className="text-mali-blue-accent mr-3" />
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <div 
                  key={index} 
                  className={`border border-mali-blue/20 rounded-lg overflow-hidden ${expandedFaqs.includes(index) ? 'bg-mali-blue/10' : ''}`}
                >
                  <button
                  ...
                  {expandedFaqs.includes(index) && (
                    <div className="p-4 pt-0 text-mali-text-secondary border-t border-mali-blue/20">
                      <p>{faq.answer}</p>
                    </div>
                  )}
                </div>
            ...
            <div className="mt-6 text-center">
              <Link href="/support/faq" className="text-mali-blue-accent hover:underline inline-flex items-center">
                View All FAQs
          ...
          <div className="bg-mali-card border border-mali-blue/20 rounded-xl p-6 sticky top-4">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-mali-blue/20 p-3 rounded-lg mr-4">
                  <Clock className="text-mali-blue-accent" size={20} />
                </div>
                <div>
              ...
              <div className="flex items-start">
                <div className="bg-mali-blue/20 p-3 rounded-lg mr-4">
                  <Mail className="text-mali-blue-accent" size={20} />
                </div>
                <div>
                  <h3 className="text-white font-medium mb-1">Email Support</h3>
                  <p className="text-mali-text-secondary mb-1">For general inquiries:</p>
                  <a href="mailto:support@maligamepass.com" className="text-mali-blue-accent hover:underline">support@maligamepass.com</a>
                  
                  <p className="text-mali-text-secondary mt-2 mb-1">For business partnerships:</p>
                  <a href="mailto:partners@maligamepass.com" className="text-mali-blue-accent hover:underline">partners@maligamepass.com</a>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-mali-blue/20 p-3 rounded-lg mr-4">
                  <MessageSquare className="text-mali-blue-accent" size={20} />
                </div>
                <div>
                  <h3 className="text-white font-medium mb-1">Live Chat</h3>
                  <p className="text-mali-text-secondary">Available during support hours. Click the chat icon in the bottom right corner to start a conversation.</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-mali-blue/20 p-3 rounded-lg mr-4">
                  <Phone className="text-mali-blue-accent" size={20} />
                </div>
                <div>
                  <h3 className="text-white font-medium mb-1">Phone Support</h3>
                  <p className="text-mali-text-secondary mb-1">Customer Service Hotline:</p>
                  <a href="tel:+66212345678" className="text-mali-blue-accent hover:underline">+66 2 123 45678</a>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-mali-blue/20 p-3 rounded-lg mr-4">
                  <Globe className="text-mali-blue-accent" size={20} />
                </div>
                <div>
                  <h3 className="text-white font-medium mb-1">Social Media</h3>
                  <div className="flex space-x-3 mt-2">
                    <a href="#" className="bg-mali-blue/20 hover:bg-mali-blue/30 p-2 rounded-lg transition-colors">
                      <svg className="w-5 h-5 text-mali-blue-accent" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
