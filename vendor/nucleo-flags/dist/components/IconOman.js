...
export const IconOman = ({ ...props }) => {
    return (React.createElement(Icon, { size: "32px", ...props },
        React.createElement("g", { className: "nc-icon-wrapper" },
            React.createElement("rect", { x: "1", y: "4", width: "30", height: "24", rx: "4", ry: "4", fill: "#cd312c" }),
            React.createElement("path", { d: "M11,20v8H27c2.209,0,4-1.791,4-4v-4H11Z", fill: "#377d41" }),
            React.createElement("path", { d: "M27,4H11V12H31v-4c0-2.209-1.791-4-4-4Z", fill: "#fff" }),
