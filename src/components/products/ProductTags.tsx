...
export function ProductTags({
  ...
  const variantStyles = {
    default:
      "bg-brutal-gray hover:bg-brutal-yellow text-black border-[2px] border-black",
    outline:
      "border-[2px] border-black hover:bg-brutal-yellow text-black bg-white",
  ...
  return (
    <div className={cn("space-y-2", className)}>
      <h3 className="text-sm font-bold text-black flex items-center gap-2 thai-font">
        <div
          className="w-6 h-6 rounded-lg bg-brutal-pink border-[2px] border-black flex items-center justify-center"
