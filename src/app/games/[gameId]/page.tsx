...
import { getGameById, GameDetails } from '@/lib/data/games';
...
export default function GameDetailsPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (gameData && gameData.topUpOptions && gameData.topUpOptions.length > 0) {
    ...
    <div className="page-container">
      ...
      <div className="bg-mali-card border border-mali-blue/20 rounded-xl overflow-hidden mb-8">
        <div className="relative h-80 md:h-96">
          {/* Main banner image */}
          <Image
            src={game.screenshots && game.screenshots.length > 0 ? game.screenshots[0] : game.mainImage}
            alt={game.title}
            fill
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm">
                  ...
                  <div className="flex items-center text-yellow-400">
                    ...
                    <span className="ml-1 text-mali-text-secondary">({game.ratingCount?.toLocaleString() || 0})</span>
                  </div>
                  {game.releaseDate && (
                ...
                <div className="mt-3">
                  ...
                  <span className="text-white">{game.developer || game.publisher}</span>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6">
                    {game.topUpOptions.map((option: any) => (
                      <div
                        ...
                        className={`relative border p-4 rounded-xl cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg ${selectedOption === option.id
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-mali-blue/10 border border-mali-blue/20 rounded-lg p-4">
                      ...
                      <p className="text-mali-text-secondary">{game.developer || "N/A"}</p>
                    </div>
                    ...
                    <div className="bg-mali-blue/10 border border-mali-blue/20 rounded-lg p-4">
                      ...
                      <p className="text-mali-text-secondary">{game.publisher || "N/A"}</p>
                    </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {game.relatedGames.map((relatedId: string) => {
                const relatedGame = getGameById(relatedId);
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {game.relatedGames.map((id: string) => {
            const relatedGame = getGameById(id);
            if (!relatedGame) return null;
