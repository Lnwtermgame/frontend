...
export function PushNotificationManager({ className }: PushNotificationManagerProps) {
  ...
  if (!isSupported) {
    return (
      <div className={`bg-white border-[3px] border-black p-4 ${className || ''}`} style={{ boxShadow: '4px 4px 0 0 #000000' }}>
          ...
          <div>
            {isSubscribed ? (
              <button
                ...
                style={{ boxShadow: isUnsubscribing ? 'none' : '3px 3px 0 0 #000000' }}
              >
                {isUnsubscribing ? (
                  <>
              ...
              <button
                ...
                style={{ boxShadow: isSubscribing ? 'none' : '3px 3px 0 0 #000000' }}
              >
                {isSubscribing ? (
                  <>
                    <RefreshCw size={16} className="mr-2 animate-spin inline" />
